...
- Identifica **5 objetos principales** que existen en una empresa de catering
...
Actividad 2: Comparación de Paradigmas - Sabores y Eventos
Diferencias entre Programación Estructurada y POO
Programación Estructurada

Organiza el código en funciones y procedimientos
Los datos y las operaciones están separados
Usa variables globales o se pasan datos entre funciones
Enfoque en qué hace el programa (procesos)
Mejor para problemas secuenciales y lineales

Programación Orientada a Objetos (POO)

Organiza el código en objetos que combinan datos y comportamientos
Los datos y métodos están encapsulados en clases
Cada objeto es independiente y reutilizable
Enfoque en qué representa el programa (entidades del mundo real)
Mejor para sistemas complejos y escalables